                ...
                try:
                    ...
                    for evt in events_list:
                        ...
                        if hasattr(evt, 'value') and evt.value is not None:
                            ...
                            key_name = evt.key.decode('utf-8') if hasattr(evt, 'key') and evt.key and isinstance(evt.key, bytes) else (evt.key if hasattr(evt, 'key') and evt.key else X)
